...
namespace gazebo
{
  class GazeboRosZoomCamera : public CameraPlugin, GazeboRosCameraUtils
  {
    /// \brief Constructor
    ...
    protected: void fovCallback(const std_msgs::Float64::ConstPtr& msg);
    
    protected: std::string fov_topic_;
    protected: double default_fov_;
    ...
    protected: ros::Subscriber fov_sub_;
  };
}
#endif
